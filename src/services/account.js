...
export const registerAccount = params => api.POST('/users/register', params);
export const validateEmail = params => api.GET('/validate_email', params);
export const setPassword = params => api.POST('/reset_password', params);
